...
Original file is located at
    https://colab.research.google.com/drive/1zmZtO4X5_1dbVf4pfgLmOGRyGhCq47Yg
"""
...
LOG_DIR = '/content/drive/My Drive/smomi/lab3.1'
SHUFFLE_BUFFER = 4
BATCH_SIZE = 80
NUM_CLASSES = 6
PARALLEL_CALLS=4
...
model = keras.models.load_model('/content/drive/My Drive/smomi/weight_model3.h5')
model.summary()
...
def main():
    ...
    model.compile(
        optimizer=tf.optimizers.SGD(lr=0.0000001, momentum=0.9),
...
# %tensorboard --logdir  '/content/drive/My Drive/smomi/lab3.1'